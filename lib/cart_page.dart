                      ...
                      child: ListTile(
                        ...
                        trailing: Row(
                          ...
                          children: [
                            ...
                            SizedBox(width: 10),
                            IconButton(onPressed: cartModel.clearNudelsuppe, icon: Icon(Icons.delete, color: Colors.white),
                            ),
                          ],
                        ),
                      ),
                      ...
                      child: ListTile(
                        ...
                        trailing: Row(
                          ...
                          children: [
                            ...
                            SizedBox(width: 10),
                            IconButton(onPressed: cartModel.clearFestival, icon: Icon(Icons.delete, color: Colors.white),
                            ),
                          ],
                        ),
                      ),
